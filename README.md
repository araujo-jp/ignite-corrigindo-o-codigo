...
:rocket: desafio 03: Corrigindo o código
</h1>

<p align="center">
   

  <img alt="Language count" src="https://img.shields.io/github/repo-size/araujo-jp/ignite-corrigindo-o-codigo"/>

  <a href="https://github.com/araujo-jp">
    <img alt="João Paulo" src="https://img.shields.io/badge/made%20by-João Paulo Araújo-%237519C1">
  </a> 

  <a href="https://github.com/araujo-jp/ignite-corrigindo-o-codigo/commits/main">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/araujo-jp/ignite-corrigindo-o-codigo">
  </a>

  <img alt="License" src="https://img.shields.io/github/license/araujo-jp/ignite-corrigindo-o-codigo">
</p>

<h1 align="center">

<img src="./.github/cover.png" alt="ignite-corrigindo-o-codigo logo" width="1000px"/>
...
```bash
# Clone this project
$ git clone https://github.com/araujo-jp/ignite-corrigindo-o-codigo.git
